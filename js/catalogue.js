		...
		.then(function (a, b, ca, cl, e, c, l, p) {
			...
			catalogueTable
				...
				.columns([
					...
					{ label: 'Classification', format: function (d) { return d.classification; } },
					{ label: 'Edition', format: function (d) { return d.edition; } },
					{ label: 'Publisher', format: function (d) { return d.publisher; } },
					{ label: 'Published Year', format: function (d) { return d.published_year; } },
					...
					{ label: 'Renewals', format: function (d) { return d.renewals; } },
