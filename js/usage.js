$(function () {
  ...
  if (path == '/index.html' || path == '/') {
    ...
    $.when($.ajax(config.usagecsv)).then(function (u) {
      ...
      var issuesTotal = removeEmpty(
        usageDateDim.group().reduceSum(function (d) {
          return d['issues']
        })
      )
      var enquiriesTotal = removeEmpty(
        usageDateDim.group().reduceSum(function (d) {
          return d['enquiries']
        })
      )
      var visitsTotal = removeEmpty(
        usageDateDim.group().reduceSum(function (d) {
          return d['visits']
        })
      )
      ...
      var issuesNumGroup = usageNdx.groupAll().reduceSum(function (d) {
        return d['issues']
      })
      issuesNumberDisplay
      ...
      var visitsNumGroup = usageNdx.groupAll().reduceSum(function (d) {
        return d['visits']
      })
      visitsNumberDisplay
        .valueAccessor(function (d) {
      ...
      var enquiriesNumGroup = usageNdx.groupAll().reduceSum(function (d) {
        return d['enquiries']
      })
      ...
      // Usage dimensions
      var usageYearDim = usageNdx.dimension(function (d) {
        return +d.year
      })
      var usageMonthDim = usageNdx.dimension(function (d) {
        return d.month
      })
      var usageBranchDim = usageNdx.dimension(function (d) {
        return d.Library
      })
      ...
      var issuesYearTotal = usageYearDim.group().reduceSum(function (d) {
        return d.issues
      })
      issuesYearChart
      ...
      var issuesMonthTotal = usageMonthDim.group().reduceSum(function (d) {
        return d['issues']
      })
      issuesMonthRowChart
      ...
      var issuesBranchTotal = usageBranchDim.group().reduceSum(function (d) {
        return d['issues']
      })
      ...
      issuesBranchBarChart.on('renderlet', function (chart) {
        chart
          ...
          .attr('transform', 'translate(-11, 40) rotate(270)')
      })
      ...
      var visitsYearTotal = usageYearDim.group().reduceSum(function (d) {
        return d.visits
      })
      visitsYearChart
      ...
      var visitsMonthTotal = usageMonthDim.group().reduceSum(function (d) {
        return d['visits']
      })
      visitsMonthRowChart
      ...
      var visitsBranchTotal = usageBranchDim.group().reduceSum(function (d) {
        return d['visits']
      })
      ...
      visitsBranchBarChart.on('renderlet', function (chart) {
        chart
          .selectAll('g.x text')
          .attr('transform', 'translate(-13, 40) rotate(270)')
      })
      ...
      var enquiriesYearTotal = usageYearDim.group().reduceSum(function (d) {
        return d.enquiries
      })
      enquiriesYearChart
      ...
      var enquiriesMonthTotal = usageMonthDim.group().reduceSum(function (d) {
        return d['enquiries']
      })
      ...
      var enquiriesBranchTotal = usageBranchDim.group().reduceSum(function (d) {
        return d['enquiries']
      })
      ...
      var pcMonthTotal = usageMonthDim
        .group()
        .reduce(reduceAdd, reduceRemove, reduceInitial)
      pcMonthRowChart
      ...
      var pcBranchDim = usageNdx.dimension(function (d) {
        return d.Library
      })
      var pcBranchTotal = pcBranchDim
        .group()
        .reduce(reduceAdd, reduceRemove, reduceInitial)
      pcBranchBarChart
